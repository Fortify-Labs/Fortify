...
export class Postgres extends ApiObject {
  /**
   * Returns the apiVersion and kind for "Postgres"
   */
  ...
  /**
   * Renders a Kubernetes manifest for "Postgres".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: PostgresProps = {}): any {
    return {
      ...Postgres.GVK,
      ...props,
    };
  ...
  public constructor(scope: Construct, id: string, props: PostgresProps = {}) {
    super(scope, id, Postgres.manifest(props));
  }
}
...
export class Redis extends ApiObject {
  /**
   * Returns the apiVersion and kind for "Redis"
   */
  public static readonly GVK: GroupVersionKind = {
    apiVersion: 'kubedb.com/v1alpha1',
    kind: 'Redis',
  ...
  /**
   * Renders a Kubernetes manifest for "Redis".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: RedisProps = {}): any {
    return {
      ...Redis.GVK,
      ...props,
    };
  ...
  public constructor(scope: Construct, id: string, props: RedisProps = {}) {
    super(scope, id, Redis.manifest(props));
  }
}
