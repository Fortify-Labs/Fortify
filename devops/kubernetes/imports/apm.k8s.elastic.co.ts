...
export class ApmServer extends ApiObject {
  ...
  public constructor(scope: Construct, id: string, props: ApmServerProps = {}) {
    super(scope, id, ApmServer.manifest(props));
  }
}
...
export interface ApmServerSpec {
   ...
   *
   * @schema ApmServerSpec#kibanaRef
   */
  readonly kibanaRef?: ApmServerSpecKibanaRef;
 ...
 * KibanaRef is a reference to a Kibana instance running in the same Kubernetes cluster. It allows APM agent central configuration management in Kibana.
 *
 * @schema ApmServerSpecKibanaRef
 */
export interface ApmServerSpecKibanaRef {
  /**
   * Name of the Kubernetes object.
   *
   * @schema ApmServerSpecKibanaRef#name
   */
  readonly name: string;
   ...
   * Namespace of the Kubernetes object. If empty, defaults to the current namespace.
   *
   * @schema ApmServerSpecKibanaRef#namespace
   */
  readonly namespace?: string;
...
export interface ApmServerSpecHttpServiceSpecPorts {
   ...
   *
   * @schema ApmServerSpecHttpServiceSpecPorts#appProtocol
   */
