...
Thank you for your interest in contributing to Fortify and subsequent open source software project by Thomas Kosiewski ("We" or "Us").
This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please confirm the reading and signing of this document on your pull request. This is a legally binding document, so please read it carefully before agreeing to it.
...
"Contribution" means any work of authorship that is Submitted by You to Us in which You own or assert ownership of the Copyright. If You do not own the Copyright in the entire work of authorship, please clearly disclose this in the corresponding pull request and code section.
...
(d) You have followed the instructions of disclosing third party copy rights, if You do not own the Copyright in the entire work of authorship Submitted.
